...
public class MyObect : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (newHead == 1)
        {
            mDirection = Vector3.right * dirspeed;
            Wheel.transform.rotation = new Quaternion(1, 0, 0,0);
        }
        else if (newHead == 2)
        {
            mDirection = -Vector3.right * dirspeed;
        ...
        {
            mDirection = Vector3.forward * dirspeed;
            Wheel.transform.rotation = new Quaternion(0, 0, 1, 0);
        }
        else if (newHead == 4)
        {
            mDirection = -Vector3.forward * dirspeed;
